...
/**
 * This class is made for the sorceress and it extends the abstract class piece
 * @author moaber231
 *
 */
public class Sorceress extends Piece{
	...
	/**Constructor
	 * <b>Postcodition:</b> set the name Sorceress ,the rank 6 ,its position and its image
	 * @param in_name Sorceress 
	 * @param in_rank 6
	 * @param in_position its position
	 * @param in_image sorceress's image
	 */
	public Sorceress(String in_name, int in_rank, int in_position, String in_image) {
		super(in_name,6, in_position, in_image);
