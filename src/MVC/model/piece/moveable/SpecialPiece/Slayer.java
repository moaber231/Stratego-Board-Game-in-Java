...
/**
 * This class is made for the Slayer and it extends the abstract class Piece
...
public class Slayer extends Piece{
	...
	/**Constructor
	 * <b>Postcodition:</b> set the name Slayer ,the rank 1 ,its position and its image
	 * @param in_name Slayer 
	 * @param in_rank 1
	 * @param in_position its position
	 * @param in_image its image
	 */
	public Slayer(String in_name, int in_rank, int in_position, String in_image) {
		super(in_name, 1, in_position, in_image);
