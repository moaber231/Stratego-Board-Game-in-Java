...
/**
 * This class is made for the yeti and it extends the abstact class piece
...
public class Yeti extends Piece {
	...
	/**Constructor
	 * <b>Postcodition:</b> set the name Yeti ,the rank 5 ,its position and its image
	 * @param in_name Yeti
	 * @param in_rank 5
	 * @param in_position its position
	 * @param in_image Yeti's image
	 */
	public Yeti(String in_name, int in_rank, int in_position, String in_image) {
